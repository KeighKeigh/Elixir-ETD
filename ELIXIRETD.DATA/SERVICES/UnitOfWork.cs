...
using ELIXIRETD.DATA.DATA_ACCESS_LAYER.REPOSITORIES.ONECHARGING_REPOSITORY;
using ELIXIRETD.DATA.DATA_ACCESS_LAYER.REPOSITORIES.OrderingRepository;
using ELIXIRETD.DATA.DATA_ACCESS_LAYER.REPOSITORIES.PENDINGREQUEST_REPOSITORY;
...
namespace ELIXIRETD.DATA.SERVICES
{
...

    {
        ...
        public IOneChargingRepository One { get; set; }

        public IPendingRequestRepository PendingRequests { get; set; }
...

        {
            ...
            One = new OneChargingRepository(_context);
