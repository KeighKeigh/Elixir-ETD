...
//{
//    public class ConsolidateGLFinanceExport
//    {
//        public class ConsolidateGLFinanceExportCommand : IRequest<Unit>
//        {
...
//        public class Handler : IRequestHandler<ConsolidateGLFinanceExportCommand, Unit>
//        {
...
//            public async Task<Unit> Handle(ConsolidateGLFinanceExportCommand command, CancellationToken cancellationToken)
//            {

//                var consolidate = await _report.Reports.ConsolidateGLFinanceReport(command.DateFrom, command.DateTo, command.Search);
