...
namespace ELIXIRETD.API.Controllers.WAREHOUSE_CONTROLLER
{
    ...
    public class WarehouseController : BaseApiController
    {
        ...
        [HttpGet]
        [Route("GetPoSummary")]
        public async Task<ActionResult<IEnumerable<PoSummaryDto>>> GetPoSummary([FromQuery] UserParams userParams, [FromQuery] string search)
        {
            ...
            var posummary = await _unitOfWork.Receives.GetPoSummary(userParams, search);
